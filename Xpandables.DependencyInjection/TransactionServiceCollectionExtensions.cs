...
{
    /// <summary>
    /// Provides methods to register transaction behavior to services.
    /// </summary>
    public static class TransactionServiceCollectionExtensions
    {
        /// <summary>
        /// Adds transaction behavior to commands and queries that are decorated with the <see cref="ITransactionBehavior"/> to the services
        /// </summary>
