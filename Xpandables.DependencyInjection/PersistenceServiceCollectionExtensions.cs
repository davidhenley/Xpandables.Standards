...
{
    /// <summary>
    /// Provides methods to register persistence behavior to services.
    /// </summary>
    public static class PersistenceServiceCollectionExtensions
    {
        /// <summary>
        /// Adds persistence behavior to commands and queries that are decorated with the <see cref="IPersistenceBehavior"/> to the services
