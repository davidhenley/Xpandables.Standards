...
{
    /// <summary>
    /// A helper class used to implement the <see cref="IAsyncCommandHandler{TCommand}"/> interface.
    /// </summary>
        ...
        where TCommand : class, ICommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="AsyncCommandHandlerBuilder{TArgument}"/> with the delegate to be used
