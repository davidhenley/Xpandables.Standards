...
namespace System.Patterns
{
    ...
    {
        /// <summary>
        /// Applies validation process and throws the <see cref="ComponentModel.DataAnnotations.ValidationException"/> if necessary.
        /// </summary>
        /// <param name="argument">The target argument to be validated, must implement <see cref="IValidatableAttribute"/>.</param>
    ...
    {
        /// <summary>
        /// Applies validation the argument and throws the <see cref="ComponentModel.DataAnnotations.ValidationException"/> if necessary.
        /// </summary>
