...
namespace System.Patterns
{
    ...
    {
        /// <summary>
        /// Applies all validators to the argument and throws the <see cref="ComponentModel.DataAnnotations.ValidationException"/> if necessary.
        /// </summary>
    ...
    public interface ICompositeValidator<in TArgument> : ICompositeValidator
