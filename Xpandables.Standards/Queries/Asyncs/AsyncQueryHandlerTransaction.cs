...
namespace System.Design.Query
{
    ...
    public sealed class AsyncQueryHandlerTransaction<TQuery, TResult> : IAsyncQueryHandler<TQuery, TResult>
        where TQuery : class, IQuery<TResult>
    {
        ...
        public AsyncQueryHandlerTransaction(IAsyncQueryHandler<TQuery, TResult> decoratee, IAttributeAccessor attributeAccessor)
        {
