...
namespace System.Design.Database.Extensions
{
    ...
    public static class DataContextExtentions
    {
            ...
            where T : class
        {
            ...
            return ((IDataQueryable<T>)source).Instance.AnyAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            ...
            return ((IDataQueryable<T>)source).Instance.AnyAsync(source, predicate, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.AllAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.CountAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.CountAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.LongCountAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.LongCountAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.FirstAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.FirstAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.FirstOrDefaultAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.FirstOrDefaultAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.LastAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.LastAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.LastOrDefaultAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.LastOrDefaultAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.SingleAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.SingleAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.SingleOrDefaultAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (predicate is null) throw new ArgumentNullException(nameof(predicate));
            return ((IDataQueryable<T>)source).Instance.SingleOrDefaultAsync(source, predicate, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.MinAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            ...
            return ((IDataQueryable<T>)source).Instance.MinAsync(source, selector, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.MaxAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (selector is null) throw new ArgumentNullException(nameof(selector));
            return ((IDataQueryable<T>)source).Instance.MaxAsync(source, selector, cancellationToken);
        }

        public static Task<TU> SumAsync<TU>([NotNull] this IQueryable<TU> source, CancellationToken cancellationToken = default)
            where TU : unmanaged
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<TU>)source).Instance.SumAsync(source, cancellationToken);
        }
        ...
        public static Task<TU> SumAsync<T, TU>(
            [NotNull] this IQueryable<T> source, [NotNull] Expression<Func<T, TU>> selector, CancellationToken cancellationToken = default)
            where T : class
            where TU : unmanaged
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (selector is null) throw new ArgumentNullException(nameof(selector));
            return ((IDataQueryable<T>)source).Instance.SumAsync(source, selector, cancellationToken);
        }
        ...
        public static Task<TU> AverageAsync<TU>([NotNull] this IQueryable<TU> source, CancellationToken cancellationToken = default)
            where TU : unmanaged
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<TU>)source).Instance.AverageAsync(source, cancellationToken);
        }
        ...
        public static Task<TU> AverageAsync<T, TU>(
            [NotNull] this IQueryable<T> source, [NotNull] Expression<Func<T, TU>> selector, CancellationToken cancellationToken = default)
            where T : class
            where TU : unmanaged
        {
            ...
            where TU : unmanaged
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            if (selector is null) throw new ArgumentNullException(nameof(selector));
            return ((IDataQueryable<T>)source).Instance.AverageAsync(source, selector, cancellationToken);
        }
            ...
            where T : class
        {
            ...
            return ((IDataQueryable<T>)source).Instance.ContainsAsync(source, item, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ToListAsync(source, cancellationToken);
        }
        ...
        {
            if (source is null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ToArrayAsync(source, cancellationToken);
        }
            ...
            where T : class
        {
            ...
            return ((IDataQueryable<T>)source).Instance.Include(source, navigationPropertyPath);
        }
            ...
            where T : class
        {
            ...
            throw new ArgumentException(ErrorMessageResources.NavigationParameterException.StringFormat(nameof(navigationPropertyPath)));
        }

        public static IQueryable<T> IgnoreQueryFilters<T>([NotNull] this IQueryable<T> source) where T : class
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.IgnoreQueryFilters(source);
        }

        public static IQueryable<T> AsNoTracking<T>([NotNull] this IQueryable<T> source) where T : class
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.AsNoTracking(source);
        }

        public static IQueryable<T> AsTracking<T>([NotNull] this IQueryable<T> source) where T : class
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.AsTracking(source);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.TagWith(source, tag);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.LoadAsync(source, cancellationToken);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ToDictionaryAsync(source, keySelector, cancellationToken);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ToDictionaryAsync(source, keySelector, comparer, cancellationToken);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ToDictionaryAsync(source, keySelector, elementSelector, cancellationToken);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ToDictionaryAsync(source, keySelector, elementSelector, comparer, cancellationToken);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.ForEachAsync(source, action, cancellationToken);
        }
        ...
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return ((IDataQueryable<T>)source).Instance.AsAsyncEnumerable(source);
        }
    }
}
