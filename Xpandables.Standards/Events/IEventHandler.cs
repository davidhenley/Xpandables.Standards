...
namespace System
{
    ...
    /// <summary>
    /// Allows an application author to define a specific type <typeparamref name="TEvent"/> to be handled asynchronously.
    /// </summary>
    /// <typeparam name="TEvent">The event type to be asynchronously handled.</typeparam>
    /// <remarks>
    /// Any operation that does not deliver or do what it promises to do should throw an exception.
    /// </remarks>
    ...
    {
        /// <summary>
        /// Defines the method that should be used when a specific type event is handled asynchronously.
        /// </summary>
