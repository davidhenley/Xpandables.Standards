...
namespace System
{
    ...
    public static class TypeExtensions
    {
        ...
        public static Optional<object> CreateInstance<TParam>(this Type type, TParam param) where TParam : notnull
        {
            if (type is null) throw new ArgumentNullException(nameof(type));
        ...
        [Diagnostics.CodeAnalysis.SuppressMessage("Design", "RCS1224:Make method an extension method.", Justification = "<En attente>")]
