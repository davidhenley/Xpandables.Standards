...
namespace SimpleInjector
{
    ...
    public class ExpressionBuildingEventArgs : EventArgs
    {
        ...
        {
            KnownImplementationType = knownImplementationType;
            Lifestyle = lifestyle;
        ...
        public Expression Expression
        {
            ...
            set
            {
                ...
                if (!KnownImplementationType.IsAssignableFrom(value.Type))
                {
        ...
        internal string DebuggerDisplay => string.Format(
            ...
            "{0}: {1}, {2}: {3}",
            nameof(KnownImplementationType),
            KnownImplementationType.ToFriendlyName(),
            nameof(KnownImplementationType),
            KnownImplementationType.ToFriendlyName());
    }
}