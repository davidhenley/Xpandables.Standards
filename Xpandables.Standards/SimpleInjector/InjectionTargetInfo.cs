...
namespace SimpleInjector
{
    ...
    public sealed class InjectionTargetInfo : ApiObject, IEquatable<InjectionTargetInfo?>
    {
        ...
        public string Name => Parameter != null ? Parameter.Name : Property!.Name;

        /// <summary>Gets the type of the target.</summary>
        /// <value>A <see cref="System.Type"/> containing the type of the target.</value>
        public Type TargetType =>
            Parameter != null ? Parameter.ParameterType : Property!.PropertyType;
        ...
        public MemberInfo Member => Parameter != null ? Parameter.Member : Property!;

        internal string DebuggerDisplay => string.Format(CultureInfo.InvariantCulture,
            "{0} {{ Name = \"{1}\", Type = {2} }}",
            Parameter != null ? "Parameter" : "Property",
            Name,
            TargetType.ToFriendlyName());

        private object Target => Parameter ?? (object)Property!;
        ...
        public object[] GetCustomAttributes(bool inherit) =>
            Parameter != null
                ? Parameter.GetCustomAttributes(inherit).ToArray()
                : Property!.GetCustomAttributes(inherit).ToArray();
        ...
        public object[] GetCustomAttributes(Type attributeType, bool inherit) =>
            Parameter != null
                ? Parameter.GetCustomAttributes(attributeType, inherit).ToArray()
                : Property!.GetCustomAttributes(attributeType, inherit).ToArray();
        ...
        public bool IsDefined(Type attributeType, bool inherit) =>
            Parameter != null
                ? Parameter.IsDefined(attributeType, inherit)
                : Property!.IsDefined(attributeType, inherit);
        ...
        public T GetCustomAttribute<T>() where T : Attribute => GetCustomAttribute<T>(inherit: true);
        ...
        public T GetCustomAttribute<T>(bool inherit) where T : Attribute =>
            Parameter != null
                ...
                : Property!.GetCustomAttribute<T>(inherit);
        ...
        public Attribute GetCustomAttribute(Type attributeType) =>
            GetCustomAttribute(attributeType, inherit: true);
        ...
        public Attribute GetCustomAttribute(Type attributeType, bool inherit) =>
            Parameter != null
                ? Parameter.GetCustomAttribute(attributeType, inherit)
                : Property!.GetCustomAttribute(attributeType, inherit);
        ...
        public IEnumerable<T> GetCustomAttributes<T>(bool inherit) where T : Attribute =>
            Parameter != null
                ? Parameter.GetCustomAttributes(typeof(T), inherit).Cast<T>()
                : Property!.GetCustomAttributes(typeof(T), inherit).Cast<T>();

        /// <inheritdoc />
        public override int GetHashCode() => Target.GetHashCode();

        /// <inheritdoc />
        public override bool Equals(object obj) => obj is InjectionConsumerInfo info && Equals(info);

        /// <inheritdoc />
        public bool Equals(InjectionTargetInfo? other) => Target.Equals(other?.Target);
    }
}