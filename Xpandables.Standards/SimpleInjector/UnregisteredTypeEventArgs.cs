...
namespace SimpleInjector
{
    ...
    public class UnregisteredTypeEventArgs : EventArgs
    {
        ...
        {
            UnregisteredServiceType = unregisteredServiceType;
        }
        ...
        public bool Handled => Expression != null || Registration != null;
            ...
            Expression =
                Expression.Call(
                    typeof(UnregisteredTypeEventArgsCallHelper).GetMethod("GetInstance")
                        .MakeGenericMethod(UnregisteredServiceType),
        ...
        public void Register(Expression expression)
        {
            ...
            Requires.ServiceIsAssignableFromExpression(
                UnregisteredServiceType, expression, nameof(expression));

            Requires.ServiceIsAssignableFromImplementation(
                UnregisteredServiceType, expression.Type, nameof(expression));
        ...
        public void Register(Registration registration)
        {
            ...
            Requires.ServiceIsAssignableFromRegistration(
                UnregisteredServiceType, registration, nameof(registration));
