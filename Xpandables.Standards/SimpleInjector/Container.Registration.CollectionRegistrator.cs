...
namespace SimpleInjector
{
    ...
    public sealed class ContainerCollectionRegistrator : ApiObject
    {
        ...
        public IList<TService> Create<TService>(IEnumerable<Assembly> assemblies) where TService : class
        {
            ...
            var types = Container.GetTypesToRegister(typeof(TService), assemblies, compositesExcluded);

            return Create<TService>(types);
        }
            ...
            where TService : class
        {
            ...
            return CreateRegistration<TService>(types);
        }
        ...
        {
            Append(serviceType, registration);
        }
        ...
        {
            Append(serviceType, implementationType);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            AppendToCollectionInternal(
                typeof(TService), lifestyle.CreateRegistration<TImplementation>(Container));
        }
        ...
        public void Append(Type serviceType, Type implementationType, Lifestyle lifestyle)
        {
            ...
            var registration = lifestyle.CreateRegistration(implementationType, Container);
            ...
            where TService : class
        {
            ...
            AppendToCollectionInternal(
                typeof(TService), lifestyle.CreateRegistration(instanceCreator, Container));
        }
        ...
        public void AppendInstance<TService>(TService instance) where TService : class
        {
            ...
            AppendToCollectionInternal(typeof(TService),
                SingletonLifestyle.CreateSingleInstanceRegistration(
                    typeof(TService), instance, Container));
        }
        ...
        public void AppendInstance(Type serviceType, object instance)
        {
            ...
            AppendToCollectionInternal(
                serviceType,
                SingletonLifestyle.CreateSingleInstanceRegistration(
                    instance.GetType(), instance, Container));
        }
        ...
        public void Register<TService>(params TService[] singletons) where TService : class
        {
            ...
            Register(typeof(TService), singletonRegistrations);
        }
        ...
        public void Register(Type serviceType, IEnumerable<Registration> registrations)
        {
            ...
            Requires.AreRegistrationsForThisContainer(Container, registrations, nameof(registrations));
            Requires.ServiceIsAssignableFromImplementations(
        ...
        public void Register(Type serviceType, IEnumerable containerUncontrolledCollection)
        {
            ...
            try
            {
                RegisterContainerUncontrolledCollection(serviceType,
        ...
        {
            var compositesExcluded = new TypesToRegisterOptions { IncludeComposites = false };
            var types = Container.GetTypesToRegister(serviceType, assemblies, compositesExcluded);
            Register(serviceType, types);
        }
            ...
            where TService : class
        {
            ...
            var collection = new ContainerControlledCollection<TService>(Container);

            collection.AppendAll(serviceTypes);

            RegisterForVerification(collection);
        ...
        {
            RegisterCollectionInternal(itemType,
        ...
        {
            CollectionResolver resolver = GetContainerControlledResolver(itemType);
        ...
        {
            var resolver = Container.GetContainerUncontrolledResolver(itemType);

            var producer = SingletonLifestyle.CreateUncontrolledCollectionProducer(
                itemType, collection, Container);
            ...
            Type itemType, IEnumerable<T> containerUncontrolledCollection)
        {
            ...
            RegisterGenericContainerUncontrolledCollection(itemType, castedCollection);
        }

        private CollectionResolver GetContainerControlledResolver(Type itemType) =>
            Container.GetCollectionResolver(itemType, containerControlled: true);
    }
}