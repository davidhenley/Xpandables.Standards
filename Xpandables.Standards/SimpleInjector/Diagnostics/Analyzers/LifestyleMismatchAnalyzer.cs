...
namespace SimpleInjector.Diagnostics.Analyzers
{
    ...
    internal sealed class LifestyleMismatchAnalyzer : IContainerAnalyzer
    {
        ...
        public DiagnosticResult[] Analyze(IEnumerable<InstanceProducer> producers) => (
            ...
            where relationship.Dependency.Registration.ShouldNotBeSuppressed(DiagnosticType)
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            "Performance", "CA1820:Vérifier la présence de chaînes vides par la longueur de chaîne", Justification = "<En attente>")]
