...
namespace SimpleInjector.Diagnostics
{
    ...
    public abstract class DiagnosticResult
    {
        ...
        public Uri DocumentationUrl =>
            DocumentationAttribute.GetDocumentationAttribute(DiagnosticType).DocumentationUrl;
        ...
        [DebuggerHidden]
        internal string Name => DocumentationAttribute.GetDocumentationAttribute(DiagnosticType).Name;
