...
namespace SimpleInjector
{
    ...
    public class ExpressionBuiltEventArgs : EventArgs
    {
        ...
        public ExpressionBuiltEventArgs(Type registeredServiceType, Expression expression)
        {
            ...
            ReplacedRegistration = null!;
            KnownRelationships = null!;
        }
            ...
            Collection<KnownRelationship> knownRelationships)
        {
            ...
            this.expression = expression;
            InstanceProducer = producer;
            lifestyle = producer.Lifestyle;
            ReplacedRegistration = replacedRegistration;
        ...
        internal string DebuggerDisplay => string.Format(
            ...
            RegisteredServiceType.ToFriendlyName(),
            nameof(RegisteredServiceType),
            RegisteredServiceType.ToFriendlyName());
    }
}