...
namespace SimpleInjector
{
    ...
    public partial class Container
    {
            ...
            Type openGenericServiceType, IEnumerable<Assembly> assemblies, Lifestyle lifestyle)
        {
            ...
            var results =
                GetNonGenericTypesToRegisterForOneToOneMapping(openGenericServiceType, assemblies);

            Register(openGenericServiceType, results.ImplementationTypes, lifestyle);

            AddSkippedDecorators(openGenericServiceType, results.SkippedDecorators);
        }
            ...
            Type openGenericServiceType, IEnumerable<Type> implementationTypes, Lifestyle lifestyle)
        {
            ...
            {
                AddRegistration(mapping.serviceType, mapping.registration);
            }
        }
            ...
            Type serviceType, IEnumerable<Assembly> assemblies, TypesToRegisterOptions options)
        {
            ...
            return GetTypesToRegisterInternal(serviceType, assemblies, options);
        }
                ...
                Type openGenericServiceType, IEnumerable<Assembly> assemblies)
        {
            ...
            Type[] typesIncludingDecorators =
                GetTypesToRegisterInternal(openGenericServiceType, assemblies, options);

            var partitions =
                typesIncludingDecorators.Partition(type => !IsDecorator(openGenericServiceType, type));
        ...
        {
            var ctor = SelectImplementationTypeConstructorOrNull(implemenationType);
        ...
        private ConstructorInfo? SelectImplementationTypeConstructorOrNull(Type implementationType)
        {
            try
            {
                return Options.SelectConstructor(implementationType);
            }
        ...
        private Type[] GetNonGenericDecoratorsThatWereSkippedDuringBatchRegistration(Type serviceType)
        {
            if (serviceType.IsGenericType)
            {
                ...
                if (skippedNonGenericDecorators.ContainsKey(typeDef))
                {
                    return skippedNonGenericDecorators[typeDef]
