...
namespace SimpleInjector
{
    ...
    public partial class Container
    {
        ...
        public ContainerCollectionRegistrator Collections => Collection;
        ...
        {
            Register<TService, TImplementation>(SelectionBasedLifestyle, "TService", "TImplementation");
        }
        ...
        public void Register<TService, TImplementation>(Lifestyle lifestyle)
            ...
            where TImplementation : class, TService
        {
            Register<TService, TImplementation>(lifestyle, nameof(TService), nameof(TImplementation));
        }
        ...
        public void Register(Type concreteType)
        {
            Register(
                ...
                lifestyle: SelectionBasedLifestyle,
        ...
        {
            Register<TConcrete, TConcrete>(Lifestyle.Singleton, nameof(TConcrete), nameof(TConcrete));
        }
            ...
            where TImplementation : class, TService
        {
            ...
            ThrowArgumentExceptionWhenTypeIsNotConstructable(
        ...
        {
            bool constructable = Options.IsConstructableType(implementationType, out string? message);
