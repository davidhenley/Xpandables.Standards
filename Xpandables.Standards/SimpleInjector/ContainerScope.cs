...
namespace SimpleInjector
{
    ...
    public class ContainerScope : ApiObject
    {
        ...
        public virtual void WhenScopeEnds(Action action) => scope.WhenScopeEnds(action);
        ...
        /// (Nothing in VB).</exception>
        /// <exception cref="ObjectDisposedException">Thrown when the container has been disposed.</exception>
        public void RegisterForDisposal(IDisposable disposable) => scope.RegisterForDisposal(disposable);
        ...
        public object? GetItem(object key) => scope.GetItem(key);
        ...
        /// (Nothing in VB).</exception>
        public void SetItem(object key, object item) => scope.SetItem(key, item);
        ...
        public IDisposable[] GetDisposables() => scope.GetDisposables();
        ...
        // Container API.
        internal void Dispose() => scope.Dispose();
    }
}