...
namespace SimpleInjector
{
    ...
    public partial class Container
    {
        ...
        public void RegisterDecorator<TService, TDecorator>(Lifestyle lifestyle)
            ...
            where TDecorator : class, TService
        {
            RegisterDecoratorCore(typeof(TService), typeof(TDecorator), lifestyle: lifestyle);
        }
        ...
        {
            RegisterDecoratorCore(serviceType, decoratorType, lifestyle: lifestyle);
        }
            ...
            Predicate<DecoratorPredicateContext> predicate)
        {
            ...
            ExpressionBuilt += interceptor.ExpressionBuilt;
        }
            ...
            Lifestyle? lifestyle = null)
        {
            ...
            var interceptor = new DecoratorInterceptor(
                new DecoratorExpressionInterceptorData(
                    this, serviceType, decoratorType, predicate, lifestyle ?? SelectionBasedLifestyle));
