...
namespace SimpleInjector
{
    ...
    public abstract class Lifestyle
    {
        ...
        protected Lifestyle(string name)
        {
            ...
            IdentificationKey = new { Type = GetType(), Name = name };
        }
        ...
        {
            return new InstanceProducer<TService>(CreateRegistration<TImplementation>(container));
        }
            ...
            where TService : class
        {
            ...
            return new InstanceProducer<TService>(CreateRegistration(implementationType, container));
        }
            ...
            Container container) where TService : class
        {
            ...
            return new InstanceProducer<TService>(CreateRegistration(instanceCreator, container));
        }
        ...
        public InstanceProducer CreateProducer(Type serviceType, Type implementationType, Container container)
        {
            ...
            return new InstanceProducer(serviceType, CreateRegistration(implementationType, container));
        }
            ...
            where TConcrete : class
        {
            ...
            return CreateRegistrationInternal<TConcrete>(container, preventTornLifestyles: true);
        }
        ...
        public Registration CreateRegistration<TService, TImplementation>(Container container)
            ...
            where TImplementation : class, TService
        {
            return CreateRegistration<TImplementation>(container);
        }
            ...
            where TService : class
        {
            ...
            var registration = CreateRegistrationCore(instanceCreator, container);
        ...
        public Registration CreateRegistration(Type concreteType, Container container)
        {
            ...
            return CreateRegistrationInternal(concreteType, container, preventTornLifestyles: true);
        }
        ...
        public Registration CreateRegistration(Type serviceType, Type implementationType, Container container)
        {
            ...
            return CreateRegistration(implementationType, container);
        }
        ...
        internal virtual int ComponentLength(Container container) => Length;

        internal virtual int DependencyLength(Container container) => Length;
        ...
        internal Registration CreateRegistrationInternal<TConcrete>(
            ...
            preventTornLifestyles
                ? CreateRegistrationFromCache<TConcrete>(container)
                : CreateRegistrationCore<TConcrete>(container);
            ...
            Type concreteType, Container container, params OverriddenParameter[] overriddenParameters)
        {
            Registration registration =
                CreateRegistrationInternal(concreteType, container, preventTornLifestyles: false);
            ...
            where TConcrete : class
        {
            lock (container.LifestyleRegistrationCache)
            {
                WeakReference weakRegistration =
                    GetLifestyleRegistrationEntryFromCache(typeof(TConcrete), container);

                var registration = (Registration)weakRegistration.Target;

                if (registration == null)
                {
                    registration = CreateRegistrationCore<TConcrete>(container);
        ...
        private WeakReference GetLifestyleRegistrationEntryFromCache(Type concreteType, Container container)
        {
            ...
            if (!lifestyleCache.TryGetValue(IdentificationKey, out registrationCache))
            {
                registrationCache = new Dictionary<Type, WeakReference>(100);
                lifestyleCache[IdentificationKey] = registrationCache;
            }
